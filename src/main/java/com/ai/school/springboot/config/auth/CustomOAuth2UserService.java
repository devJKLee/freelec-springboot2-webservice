package com.ai.school.springboot.config.auth;

import com.ai.school.springboot.config.auth.dto.OAuthAttributes;
import com.ai.school.springboot.config.auth.dto.SessionUser;
import com.ai.school.springboot.domain.user.User;
import com.ai.school.springboot.domain.user.UserRepository;
